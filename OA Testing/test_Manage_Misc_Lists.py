...
class test_Manage_Misc_Lists(unittest.TestCase):
    ...
    def test_misc_lists_load_and_get(self):
        ...
        misc_manager.load_set(app_config.test_file_path + app_config.test_misc_list_filename)
    ...
    def test_misc_lists_save(self):
        ...
        misc_manager.load_set(app_config.test_file_path + app_config.test_misc_list_filename + '2')
        loaded = misc_manager.get_current_set()
        ...
        misc_manager.save_one(loaded.all_items[0])
        misc_manager.save_one(loaded.all_items[1])
        misc_manager.save_one(loaded.all_items[2])
        misc_manager.save_one(loaded.all_items[3])
        misc_manager.save_all(app_config.test_file_path + app_config.test_misc_list_filename + '2',app_config.test_file_path + app_config.test_backup_archive_filename)
        misc_manager.load_set(app_config.test_file_path + app_config.test_misc_list_filename + '2')
        loaded2 = misc_manager.get_current_set()
    ...
    def test_misc_list_remove(self):
        ...
        misc_manager.remove_item(misc_manager.get_current_set().all_items[1])
        self.assertEqual(len(misc_manager.get_current_set()),num_list - 1)

    def test_misc_list_launch_edit(self):
        misc_manager = Manage_Misc_Lists.Manage_misc_lists()
        misc_manager.load_set(app_config.test_file_path + app_config.test_misc_list_filename)
        gui = misc_manager.launch_edit(None,misc_manager.get_current_set().all_items[1].name,True)
        self.assertNotEqual(gui,None)

    def test_misc_lists_launch_list(self):
        misc_manager = Manage_Misc_Lists.Manage_misc_lists()
        misc_manager.load_set(app_config.test_file_path + app_config.test_misc_list_filename)
        gui = misc_manager.launch_list('Misc Lists',True)
        self.assertNotEqual(gui,None)
