...
class test_Archtype(unittest.TestCase):
    ...
    def test_archtype_equal(self):
        self.assertTrue(test__data.test_archtype1.equals(test__data.test_archtype2))

    def test_archtype_inequality(self):
        self.assertFalse(test__data.test_archtype1.equals(test__data.test_archtype3))

    def test_archtype_clone(self):
        clone = test__data.test_archtype1.clone()

        self.assertTrue(test__data.test_archtype1.equals(clone))

        clone.short_description = 'modified short desc'
        self.assertFalse(test__data.test_archtype1.equals(clone))
