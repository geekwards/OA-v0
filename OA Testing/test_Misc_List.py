...
class test_Misc_List(unittest.TestCase):
    ...
    def test_misc_list_get_list(self):
        ...
        self.assertTrue(test_object1.get_list()[0],'Testlist 1.1')
        self.assertTrue(test_object1.get_list()[1],'Testlist 1.2')
        self.assertTrue(test_object1.get_list()[2],'Testlist 1.3')
    ...
    def test_misc_list_unequal(self):
        test_object1 = Misc_List.Misclist('Test1',['Testlist 1.1','Testlist 1.2','Testlist 1.3'])
        test_object2 = Misc_List.Misclist('Test1',['Testlist 1.1','Testlist 1.2','Testlist 1.3'])
    ...
    def test_misc_list_add_new(self):
        ...
        self.assertTrue(test_object1.get_list()[1],'Testlist 1.2')
        self.assertTrue(test_object1.get_list()[2],'Testlist 1.3')
        self.assertTrue(test_object1.get_list()[3],'Testlist 1.4')
    ...
    def test_misc_list_remove(self):
        ...
        self.assertTrue(test_object1.get_list()[0],'Testlist 1.1')
        self.assertTrue(test_object1.get_list()[1],'Testlist 1.3')
