...
class test_Race(unittest.TestCase):
    def test_clone(self):
        ...
        self.assertEqual(clone,test__data.test_race1)

    def test_isempty(self):
        self.assertTrue(test__data.test_race_empty.isempty())
        clone = test__data.test_race_empty.clone()
        clone.name = 'Modified'
    ...
    def test_equals(self):
        ...
        self.assertFalse(test__data.test_race1 == test__data.test_race2)

    def test_equal_bad_data(self):
        try:
            self.assertFalse(test__data.test_race1 == test__data.test_weapon1)
        except ValueError:
            pass
