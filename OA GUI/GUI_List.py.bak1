...
#    Nov 23, 2018 06:24:37 AM EST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.lblTitle.place(relx=0.018, rely=0.022, height=51, width=514)
        ...
        self.lblTitle.configure(width=514)

        self.lblListItem = tk.Label(top)
        self.lblListItem.place(relx=0.018, rely=0.119, height=30, width=400)
        ...
        self.lblListItem.configure(width=404)

        self.EditListItem = tk.Button(top)
        self.EditListItem.place(relx=0.773, rely=0.125, height=25, width=50)
        ...
        self.RemoveListItem.place(relx=0.847, rely=0.125, height=25, width=50)
        ...
        self.RemoveListItem.configure(width=51)

        self.chkListItem = tk.Checkbutton(top)
        self.chkListItem.place(relx=0.018, rely=0.119, relheight=0.033
                , relwidth=0.737)
        ...
        self.Return.place(relx=0.755, rely=0.879, height=64, width=107)
        ...
        self.Return.configure(width=107)

        self.Cancel = tk.Button(top)
        self.Cancel.place(relx=0.037, rely=0.879, height=64, width=107)
        ...
        self.Save.place(relx=0.534, rely=0.879, height=64, width=107)
        ...
        self.CopyList.place(relx=0.276, rely=0.879, height=64, width=107)
        ...
        self.AddListItem.place(relx=0.018, rely=0.163, height=25, width=50)
