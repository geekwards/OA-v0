...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.f1.lblproficiency.grid(sticky='e', row=3, column=1)
        ...
        self.f1.lblshortdescription.grid(sticky='e', row=4, column=1)
        ...
        self.f1.lblbonuses.grid(sticky='se', row=7, column=1, rowspan=2)

        self.f1.lblstr = tk.Label(self.f1, text='STR')
        self.f1.lblstr.grid(sticky='e', row=9, column=1)
        ...
        self.f1.lblper.grid(sticky='e', row=10, column=1)
        ...
        self.f1.lblint.grid(sticky='e', row=11, column=1)
        ...
        self.f1.lbldex.grid(sticky='e', row=12, column=1)

        self.f1.lblcha = tk.Label(self.f1, text='CHA')
        self.f1.lblcha.grid(sticky='e', row=13, column=1)

        self.f1.lblvit = tk.Label(self.f1, text='VIT')
        self.f1.lblvit.grid(sticky='e', row=14, column=1)

        self.f1.lblmag = tk.Label(self.f1, text='MAG')
        self.f1.lblmag.grid(sticky='e', row=15, column=1)
        ...
        self.f1.lblfeats.grid(sticky='e', row=9, column=3)

        self.f1.lblmvmt = tk.Label(self.f1, text='Mvmt')
        self.f1.lblmvmt.grid(sticky='e', row=10, column=3)

        self.f1.lblskillpts = tk.Label(self.f1, text='Skill Pts')
        self.f1.lblskillpts.grid(sticky='e', row=11, column=3)

        self.f1.lblvlhealth = tk.Label(self.f1, text='Lvl Health')
        self.f1.lblvlhealth.grid(sticky='e', row=12, column=3)
        ...
        self.f1.lblstamina.grid(sticky='e', row=13, column=3)
        ...
        self.f1.lblattack.grid(sticky='e', row=14, column=3)

        self.f1.lblreflex = tk.Label(self.f1, text='Reflex')
        self.f1.lblreflex.grid(sticky='e', row=15, column=3)
        ...
        self.f1.left_button = tk.Button(self.f1, text='Close')
        self.f1.left_button.config(width=10, height=2)
        self.f1.left_button.configure(command=GUI_Archtype_support.close_click)
        self.f1.left_button.grid(sticky='w', row=16, column=2)
